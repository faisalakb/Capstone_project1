...
> In this capstone website project : We develop a website for web developement course; to learn how to desgin a responsive  website using HTML CSS JavaScript, Bootstrap, Flexbox and grid from Figma.

## 🛠 Built With <a name="built-with"></a>

### Tech Stack <a name="tech-stack"></a>

> We are using HTML5,CSS,Javascript,Bootstrap Figma and Formspree fpr forms for this project.
...
-Desktop & Mobile view.
-Use Bootstrap, flexbox and css grid for  responsiveness
-Using figma to set the css
-Use javascript for windows responsiveness
...
- [Live Demo Link](https://faisalakb.github.io/Capstone_project1/)
...
>Create a folder on your local machine and then type: git clone https://github.com/faisalakb/Capstone_project1
...
commands:
  ...
  git clone https://github.com/faisalakb/Capstone_project1
